...
const Navbar = (props: Props) => {
	...
	return (
		<header className="fixed right-0 h-[52.5px] left-0 top-0 px-4 bg-black/40 backdrop-blur-lg z-[100] flex items-center border-b-[1px] border-neutral-900 justify-between">
