		...
		<footer className="bg-white dark:bg-gray-900">
			<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
				<div className="md:flex md:justify-between">
					<div className="mb-6 md:mb-0">
						<span className=" text-2xl font-semibold whitespace-nowrap items-center flex dark:text-white">
							...
							<Image
								...
								height={15}
								alt="fuzzi logo"
								className="shadow-sm w-[15px] h-[15px]"
							/>
					...
					<div className="grid grid-cols-2 gap-8 sm:gap-6 ">
						<div>
							...
							<ul className="text-gray-500 dark:text-gray-400 font-medium ml-0">
								<li className="mb-4">
									<a
										href=""
				...
				<div className="sm:flex flex sm:items-center sm:justify-between">
					<span className="text-sm text-gray-500 flex gap-[20px] sm:text-center dark:text-gray-400">
						© 2023{" "}
						<a
							href=""
							className="hover:underline items-center flex"
						>
